...
inline bool Group<key_t, val_t, seq, max_model_n>::incremental_training(
  ...
  std::vector<double> delta_model_keys(delta_size * feature_len);
  std::vector<std::pair<double *, size_t>> delta_key_vector(delta_size);
  ...
  std::vector<double> inserted_model_keys(inserted_size * feature_len);
  std::vector<std::pair<double *, size_t>> inserted_key_vector(inserted_size);
